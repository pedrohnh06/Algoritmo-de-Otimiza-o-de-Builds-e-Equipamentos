...
def main():
    ...
    try: 
        ...
        print("Save encontrado e carregado com sucesso!")
    except FileExistsError:
        print("Nenhum save encontrado. Iniciando um novo jogo")
        p1.equipar_item(bau_de_armas[0])
    ...
    while True:
        ...
        if escolha == "1":
            ...
            for indice, item in enumerate(bau_de_armas):
                ...
                print(f" [{indice + 1}] - {tipo}: {item.nome_equipamento} ({item.raridade})")
                print("-"*30)
